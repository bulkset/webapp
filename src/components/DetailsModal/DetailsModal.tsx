  ...
  return (
    ...
    >
      ...
      >
        ...
        {(post.facebookLink || post.twitterLink || post.instagramLink) && (
          <div className="flex gap-[11px] shrink-0 px-3 pb-3">
            {post.facebookLink && (
              <a href={post.facebookLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 bg-[#1877F2] rounded-[8px] px-2 py-2 active:scale-95 transition-transform duration-100 min-w-0 flex-1 no-underline">
                ...
                <span className="font-inter font-bold text-[10px] text-white text-center leading-[150%]">{t.detailsModal.facebook}</span>
              </a>
            )}
            {post.twitterLink && (
              <a href={post.twitterLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 bg-[#000000] rounded-[8px] px-2 py-2 active:scale-95 transition-transform duration-100 min-w-0 flex-1 no-underline">
                ...
                <span className="font-inter font-bold text-[10px] text-white text-center leading-[150%]">{t.detailsModal.twitter}</span>
              </a>
            )}
            {post.instagramLink && (
